...
if __name__ == "__main__":
    ...
    LibraryDB().addEvent("event1", "Конференция по искусственному интеллекту.", "2026-01-15", "10:00",
                         "Актовый зал университета", 50, 200, "conference", "/events/ai.jpg", "ITeen Academy",
                         "Доклады и дискуссии по AI", "Полное описание конференции", "admin", True)
    LibraryDB().addEvent("event2", "Фестиваль уличной еды.", "2026-02-02", "12:30", "Центральная площадь", 100, 500,
                         "festival", "/events/foodfest.jpg", "Городская администрация",
                         "Программа дегустаций и мастер-классов", "Полное описание фестиваля", "admin", True)
    LibraryDB().addEvent("event3", "Выставка современного искусства.", "2026-03-10", "11:00", "Городская галерея", 30,
                         150, "exhibition", "/events/art.jpg", "Союз художников", "Экспозиции и лекции",
                         "Полное описание выставки", "admin", True)
    LibraryDB().addEvent("event4", "Турнир по шахматам.", "2026-04-05", "16:00", "Дом культуры", 20, 80, "sport",
                         "/events/chess.jpg", "Федерация шахмат", "Турнирная сетка", "Полное описание турнира", "admin",
                         True)
    LibraryDB().addEvent("event5", "Концерт классической музыки.", "2026-05-20", "19:30", "Филармония", 60, 300,
                         "concert", "/events/classic.jpg", "Филармония", "Программа концерта",
                         "Полное описание концерта", "admin", True)
    LibraryDB().addEvent("event6", "Литературный вечер поэзии.", "2026-06-12", "18:00", "Библиотека им. Пушкина", 40,
                         120, "literature", "/events/poetry.jpg", "Библиотека им. Пушкина", "Чтение стихов",
                         "Полное описание вечера", "admin", True)
    LibraryDB().addEvent("event7", "Спортивный марафон.", "2026-07-01", "09:00", "Городской стадион", 200, 1000,
                         "sport", "/events/marathon.jpg", "Спортивный комитет", "Маршрут и расписание",
                         "Полное описание марафона", "admin", True)
    LibraryDB().addEvent("event8", "Кинофестиваль документальных фильмов.", "2026-08-18", "17:00",
                         "Кинотеатр «Октябрь»", 70, 250, "film", "/events/filmfest.jpg", "Кинотеатр «Октябрь»",
                         "Программа показов", "Полное описание фестиваля", "admin", True)
    LibraryDB().addEvent("event9", "Ярмарка ремесел и хендмейда.", "2026-09-25", "13:00", "Выставочный центр", 80, 400,
                         "fair", "/events/crafts.jpg", "Ассоциация ремесленников", "Программа ярмарки",
                         "Полное описание ярмарки", "admin", True)
    LibraryDB().addEvent("event10", "Семинар по личным финансам.", "2026-10-30", "15:00", "Конференц-зал бизнес-центра",
                         25, 100, "seminar", "/events/finance.jpg", "Бизнес-центр", "Программа семинара",
                         "Полное описание семинара", "admin", True)
